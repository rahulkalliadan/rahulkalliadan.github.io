...
<section id="experience" class="rk-section">
  <div class="rk-container">
    <h2 class="rk-h2">Experience</h2>

    <article class="rk-card rk-exp">
      <header class="rk-exp__head">
        <h3 class="rk-h3">Lionsbot — Senior Mechanical Engineer</h3>
        <span class="rk-exp__meta">Commercial cleaning robots · 2022 — 2024</span>
      </header>
      <ul class="rk-bullets">
    ...
    <article class="rk-card rk-exp">
      <header class="rk-exp__head">
        <h3 class="rk-h3">Botsync — Mechanical Engineer → Senior</h3>
        <span class="rk-exp__meta">AMRs for warehouses & factories · 2020 — 2022</span>
      </header>
      <ul class="rk-bullets">
    ...
    <article class="rk-card rk-exp">
      <header class="rk-exp__head">
        <h3 class="rk-h3">Early Roles — Material Handling (FMCG)</h3>
        <span class="rk-exp__meta">Conveyors & on-site commissioning · 2018 — 2019</span>
      </header>
      <ul class="rk-bullets">
...
<!-- Optional: keep recent posts header (feed appears automatically) -->
<section class="rk-section">
  <div class="rk-container">
    <h2 class="rk-h2">Recent Articles</h2>
  </div>
</section>
